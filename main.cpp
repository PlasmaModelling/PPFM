...
// Multi state, with threshold, for elastic interaction
cibox[19]->TCScalculator = new MultiCs ( i, {
...
// Other way of setting for a single state charge exchange for H - H+ 
cibox[19]->ChargeTransfer( 28.69, 1.3 );
...
// Get info on the edited collision integrals
cibox.info();
